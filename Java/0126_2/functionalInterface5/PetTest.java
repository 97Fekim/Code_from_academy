...
public class PetTest {
    ...
    private static void matchPet(PetMatcher matcher, Pet pet){
    ...
    public static void main(String[] args) {
        ...
        Pet.pets.add(new Pet(900.00));
        Pet.pets.add(new Pet(800.00));
        Pet.pets.add(new Pet(700.00));
        Pet.pets.add(new Pet(750.00));
        Pet.pets.add(new Pet(850.00));
...
//        };
//
//        matchPet("Poodles",breadMatcher, new Pet(null, "dog",  0.0));
//
...
//            }
//        };
//        matchPet("Pets for $800 or less", priceMatcher, new Pet(null, null,  750.0));
        ...
        matchPet(priceMatcher, new Pet(870.0));
